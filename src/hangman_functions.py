...
def ganhou(i, secret_word, right_letter):
    ...
    if i == 5:
        print(str(hangman_texts.fases[5]))
        print("Você perdeu.")
...
def choose_database():
    ...
    while True:
        ...
        if choice == '1':
            return random.choice(hangman_texts.banco_animais)
        
        elif choice == '2':
            return random.choice(hangman_texts.banco_alimentos)
        
        elif choice == '3':
            return random.choice(hangman_texts.banco_objetos)
...
def fase():
    ...
    while ganhou(i, secret_word, right_letter) == 0:
        print(str(hangman_texts.fases[i]))
